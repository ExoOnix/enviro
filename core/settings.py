...
CSRF_TRUSTED_ORIGINS = os.environ.get("DJANGO_CSRF_TRUSTED_ORIGINS", "http://localhost:8081").split(",")
...
CACHES = {
    "default": {
        ...
        "LOCATION": os.environ.get("CELERY_BROKER_URL", "redis://127.0.0.1:6379/1"),
        "OPTIONS": {
